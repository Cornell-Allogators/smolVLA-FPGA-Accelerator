...
We specifically target the Vision Encoder component of the SmolVLA architecture, which is responsible for generating visual embeddings from camera inputs. The contributions of this report are as follows:
